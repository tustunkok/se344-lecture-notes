\documentclass[paper=a4,fontsize=11,parskip=full,pagesize=auto,headsepline=true,chapterprefix=true,oneside]{scrbook}
...
\begin{document}
    ...
    \input{chapters/03-mccabes-cyclomatic-complexity}
    \input{chapters/04-data-flow-testing}
    \input{chapters/05-static-unit-testing}
    \input{chapters/06-blackbox-testing}
    \input{chapters/07-selenium-demo}
    
    \appendix
    \input{chapters/08-appendix1}
